...
const Navbar = ({ activeTab, setActiveTab, toggleTheme }: NavbarProps) => {
    ...
    const getNavbarStyle = () => {
        return {
            ...
            borderRight: theme === 'cyberpunk' ? '1px solid rgba(157, 78, 221, 0.3)' : '1px solid #e5e7eb', // Change from borderLeft to borderRight
            display: 'flex',
    ...
    return (
        <nav style={getNavbarStyle()}>
            {/* GitHub repo link at the very top */}
            <div style={{ 
                width: '100%',
                display: 'flex',
                justifyContent: 'center',
            ...
            {/* Main navigation buttons - centered vertically */}
            <div style={{ 
                display: 'flex',
                flexDirection: 'column' as const,
                alignItems: 'center',
                ...
                flex: 1,
                width: '100%',
                gap: '1.5rem' // Add consistent spacing between buttons
            }}>
                <button
                ...
                <button
                    ...
                    style={getButtonStyle(activeTab === 'downloads')}
